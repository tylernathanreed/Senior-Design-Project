//* Description *//
// Usage: ds_polygon_find_y(polygon, index);
// Function: Returns the Y Position of the specified Point within the specified Polygon
// Arguments:
...
yy = yorigin + lengthdir_y(dist, dir + rotation);

// Offset the Point by the Position
yy += ds_map_find_value(polygon, "y");
